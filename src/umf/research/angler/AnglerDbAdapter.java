...
public class AnglerDbAdapter {
	...
	public static final String CREATE_TABLE_lakes = "CREATE TABLE lakes (_id INTEGER PRIMARY KEY,  name TEXT,  map_resID INTEGER,  satImage_resID INTEGER, depthImage_resID INTEGER, latitude FLOAT, longitude FLOAT,  maxDepth INTEGER,  meanDepth INTEGER,  area INTEGER,  elevation INTEGER,  boatInfo TEXT,  fishingInfo TEXT,  iceFishingInfo TEXT);";
	public static final String CREATE_TABLE_fish = "CREATE TABLE fish (_id INTEGER PRIMARY KEY ,  name TEXT,  description TEXT,  fish_resID INTEGER );";
	public static final String CREATE_TABLE_lakesFish = "CREATE TABLE lakesFish (_id INTEGER PRIMARY KEY ,  lakeid INTEGER,  fishid INTEGER );";
	...
	public static final String [] INSERT_DATA_fish = new String [] {
		"INSERT INTO fish VALUES (1 , 'Landlocked Salmon', 'none' , " + R.drawable.landlocked_salmon + ");",
		"INSERT INTO fish VALUES (2 , 'Brook Trout', 'none' , " + R.drawable.brook_trout + ");",
		"INSERT INTO fish VALUES (3 , 'Rainbow Smelt' , 'none', " + R.drawable.rainbow_smelt + ");",
		"INSERT INTO fish VALUES (4 , 'Rainbow Smelt' , 'none', " + R.drawable.rainbow_smelt + ");",
		"INSERT INTO fish VALUES (5 , 'Chain Pickerel', 'none' , " + R.drawable.chain_pickerel + ");",
		"INSERT INTO fish VALUES (6 , 'Hornpout' , 'none', " + R.drawable.hornpout + ");",
		"INSERT INTO fish VALUES (7 , 'Brook trout' , 'none', " + R.drawable.brook_trout + ");",
		"INSERT INTO fish VALUES (8 , 'Lake Trout', 'none', " + R.drawable.lake_trout + ");",
		"INSERT INTO fish VALUES (9 , 'Yellow Perch', 'none', " + R.drawable.yellow_perch + ");",
		"INSERT INTO fish VALUES (10 , 'Cusk' , 'none', " + R.drawable.cusk + ");",
		"INSERT INTO fish VALUES (11 , 'Yellow Perch', 'none' , " + R.drawable.yellow_perch + ");",
		"INSERT INTO fish VALUES (12 , 'Brown Trout', 'none' , " + R.drawable.brown_trout + ");",
		"INSERT INTO fish VALUES (13 , 'Yellow Perch', 'none' , " + R.drawable.yellow_perch + ");",
		"INSERT INTO fish VALUES (14 , 'Smallmouth Bass', 'none' , " + R.drawable.smallmouth_bass + ");",
		"INSERT INTO fish VALUES (15 , 'White Perch', 'none' , " + R.drawable.white_perch + ");",
		"INSERT INTO fish VALUES (16 , 'Whitefish', 'none' , " + R.drawable.whitefish + ");",
		"INSERT INTO fish VALUES (17 , 'Brook Trout', 'none' , " + R.drawable.brook_trout + ");",
		"INSERT INTO fish VALUES (18 , 'Splake', 'none' , " + R.drawable.splake + ");",
		"INSERT INTO fish VALUES (19 , 'Hornpout', 'none' , " + R.drawable.hornpout + ");",
		"INSERT INTO fish VALUES (20 , 'White Perch', 'none' , " + R.drawable.white_perch + ");",
		"INSERT INTO fish VALUES (21 , 'Chain Pickerel', 'none' , " + R.drawable.chain_pickerel + " );",
		"INSERT INTO fish VALUES (22 , 'Yellow Perch', 'none' , " + R.drawable.yellow_perch + ");",
		"INSERT INTO fish VALUES (23 , 'Largemouth Bass', 'none' , " + R.drawable.largemouth_bass + ");",
		"INSERT INTO fish VALUES (24 , 'Northern Pike', 'none' , " + R.drawable.northern_pike + ");"
		};
	
	public static final String [] INSERT_DATA_lakesFish = new String [] {
		/*"INSERT INTO lakesFish values(1, 1, 2);",
		"INSERT INTO lakesFish values(2, 3, 1);",
		"INSERT INTO lakesFish values(3, 3, 2);",
		"INSERT INTO lakesFish values(4, 3, 4);",
		"INSERT INTO lakesFish values(5, 3, 9);",
		"INSERT INTO lakesFish values(6, 3, 6);",
		"INSERT INTO lakesFish values(7, 2, 1);",
		"INSERT INTO lakesFish values(8, 2, 12);",
		"INSERT INTO lakesFish values(9, 2, 2);",
		"INSERT INTO lakesFish values(10, 2, 4);",
		"INSERT INTO lakesFish values(11, 2, 14);",
		"INSERT INTO lakesFish values(12, 2, 15);",
		"INSERT INTO lakesFish values(13, 2, 9);",
		"INSERT INTO lakesFish values(14, 2, 5);",
		"INSERT INTO lakesFish values(15, 2, 6);",*/
		...
		"INSERT INTO lakesFish values( 7 , 3, 4);", 
		"INSERT INTO lakesFish values( 8 , 3, 5);", 
		"INSERT INTO lakesFish values( 9 , 3, 6);", 
		...
		"INSERT INTO lakesFish values( 22 , 11, 6);", 
		"INSERT INTO lakesFish values( 23 , 12, 2);", 
		"INSERT INTO lakesFish values( 24 , 13, 2);", 
		"INSERT INTO lakesFish values( 25 , 14, 2);", 
		"INSERT INTO lakesFish values( 26 , 14, 6);", 
		"INSERT INTO lakesFish values( 27 , 15, 7);", 
		"INSERT INTO lakesFish values( 28 , 16, 2);", 
		"INSERT INTO lakesFish values( 29 , 16, 4);", 
		"INSERT INTO lakesFish values( 30 , 16, 6);", 
		"INSERT INTO lakesFish values( 31 , 17, 1);", 
		"INSERT INTO lakesFish values( 32 , 17, 2);", 
		"INSERT INTO lakesFish values( 33 , 17, 8);", 
		"INSERT INTO lakesFish values( 34 , 17, 4);", 
		"INSERT INTO lakesFish values( 35 , 17, 9);", 
		"INSERT INTO lakesFish values( 36 , 17, 10);", 
		"INSERT INTO lakesFish values( 37 , 18, 2);", 
		"INSERT INTO lakesFish values( 38 , 18, 11);", 
		"INSERT INTO lakesFish values( 39 , 19, 2);", 
		"INSERT INTO lakesFish values( 40 , 19, 9);", 
		"INSERT INTO lakesFish values( 41 , 19, 6);", 
		"INSERT INTO lakesFish values( 42 , 20, 2);", 
		"INSERT INTO lakesFish values( 43 , 20, 3);", 
		"INSERT INTO lakesFish values( 44 , 21, 7);", 
		"INSERT INTO lakesFish values( 45 , 22, 1);", 
		"INSERT INTO lakesFish values( 46 , 22, 2);", 
		"INSERT INTO lakesFish values( 47 , 22, 12);", 
		"INSERT INTO lakesFish values( 48 , 22, 4);", 
		"INSERT INTO lakesFish values( 49 , 22, 9);", 
		"INSERT INTO lakesFish values( 50 , 22, 6);", 
		...
		"INSERT INTO lakesFish values( 55 , 25, 4);", 
		"INSERT INTO lakesFish values( 56 , 25, 13);", 
		...
		"INSERT INTO lakesFish values( 63 , 30, 14);", 
		"INSERT INTO lakesFish values( 64 , 30, 15);", 
		"INSERT INTO lakesFish values( 65 , 30, 9);", 
		"INSERT INTO lakesFish values( 66 , 30, 5);", 
		"INSERT INTO lakesFish values( 67 , 30, 6);", 
		"INSERT INTO lakesFish values( 68 , 31, 1);", 
		"INSERT INTO lakesFish values( 69 , 31, 2);", 
		"INSERT INTO lakesFish values( 70 , 31, 4);", 
		"INSERT INTO lakesFish values( 71 , 31, 9);", 
		"INSERT INTO lakesFish values( 72 , 31, 5);", 
		"INSERT INTO lakesFish values( 73 , 31, 6);", 
		"INSERT INTO lakesFish values( 74 , 32, 2);", 
		"INSERT INTO lakesFish values( 75 , 32, 3);", 
		"INSERT INTO lakesFish values( 76 , 33, 2);", 
		"INSERT INTO lakesFish values( 77 , 33, 6);", 
		"INSERT INTO lakesFish values( 78 , 34, 2);", 
		"INSERT INTO lakesFish values( 79 , 35, 12);", 
		"INSERT INTO lakesFish values( 80 , 35, 2);", 
		"INSERT INTO lakesFish values( 81 , 35, 3);", 
		"INSERT INTO lakesFish values( 82 , 36, 7);", 
		"INSERT INTO lakesFish values( 83 , 36, 9);", 
		"INSERT INTO lakesFish values( 84 , 36, 6);", 
		"INSERT INTO lakesFish values( 85 , 37, 2);", 
		"INSERT INTO lakesFish values( 86 , 38, 1);", 
		"INSERT INTO lakesFish values( 87 , 38, 2);", 
		"INSERT INTO lakesFish values( 88 , 38, 4);", 
		"INSERT INTO lakesFish values( 89 , 38, 9);", 
		"INSERT INTO lakesFish values( 90 , 38, 6);", 
		"INSERT INTO lakesFish values( 91 , 39, 1);", 
		"INSERT INTO lakesFish values( 92 , 39, 2);", 
		"INSERT INTO lakesFish values( 93 , 39, 4);", 
		"INSERT INTO lakesFish values( 94 , 39, 9);", 
		"INSERT INTO lakesFish values( 95 , 39, 6);", 
		"INSERT INTO lakesFish values( 96 , 40, 2);", 
		"INSERT INTO lakesFish values( 97 , 40, 6);", 
		"INSERT INTO lakesFish values( 98 , 41, 1);", 
		"INSERT INTO lakesFish values( 99 , 41, 8);", 
		"INSERT INTO lakesFish values( 100 , 41, 2);", 
		"INSERT INTO lakesFish values( 101 , 41, 16);", 
		"INSERT INTO lakesFish values( 102 , 41, 3);", 
		"INSERT INTO lakesFish values( 103 , 42, 1);", 
		"INSERT INTO lakesFish values( 104 , 42, 7);", 
		"INSERT INTO lakesFish values( 105 , 42, 13);", 
		"INSERT INTO lakesFish values( 106 , 43, 2);", 
		"INSERT INTO lakesFish values( 107 , 44, 1);", 
		"INSERT INTO lakesFish values( 108 , 44, 2);", 
		"INSERT INTO lakesFish values( 109 , 44, 12);", 
		...
		"INSERT INTO lakesFish values( 114 , 47, 8);", 
		...
		"INSERT INTO lakesFish values( 124 , 53, 8);", 
		"INSERT INTO lakesFish values( 125 , 53, 17);", 
		...
		"INSERT INTO lakesFish values( 139 , 61, 12);", 
		"INSERT INTO lakesFish values( 140 , 61, 18);", 
		"INSERT INTO lakesFish values( 141 , 61, 4);", 
		"INSERT INTO lakesFish values( 142 , 61, 14);", 
		"INSERT INTO lakesFish values( 143 , 61, 19);", 
		"INSERT INTO lakesFish values( 144 , 61, 20);", 
		"INSERT INTO lakesFish values( 145 , 62, 2);", 
		"INSERT INTO lakesFish values( 146 , 63, 1);", 
		"INSERT INTO lakesFish values( 147 , 63, 2);", 
		"INSERT INTO lakesFish values( 148 , 63, 12);", 
		"INSERT INTO lakesFish values( 149 , 63, 4);", 
		"INSERT INTO lakesFish values( 150 , 63, 9);", 
		"INSERT INTO lakesFish values( 151 , 63, 6);", 
		"INSERT INTO lakesFish values( 152 , 64, 2);", 
		"INSERT INTO lakesFish values( 153 , 64, 12);", 
		"INSERT INTO lakesFish values( 154 , 64, 18);", 
		"INSERT INTO lakesFish values( 155 , 64, 4);", 
		"INSERT INTO lakesFish values( 156 , 64, 14);", 
		"INSERT INTO lakesFish values( 157 , 64, 19);", 
		"INSERT INTO lakesFish values( 158 , 64, 20);", 
		"INSERT INTO lakesFish values( 159 , 65, 2);", 
		"INSERT INTO lakesFish values( 160 , 66, 2);", 
		"INSERT INTO lakesFish values( 161 , 67, 1);", 
		"INSERT INTO lakesFish values( 162 , 67, 17);", 
		"INSERT INTO lakesFish values( 163 , 68, 2);", 
		"INSERT INTO lakesFish values( 164 , 68, 6);", 
		...
		"INSERT INTO lakesFish values( 172 , 73, 13);", 
		"INSERT INTO lakesFish values( 173 , 74, 2);", 
		"INSERT INTO lakesFish values( 174 , 75, 2);", 
		"INSERT INTO lakesFish values( 175 , 75, 6);", 
		"INSERT INTO lakesFish values( 176 , 76, 1);", 
		"INSERT INTO lakesFish values( 177 , 76, 8);", 
		"INSERT INTO lakesFish values( 178 , 76, 2);", 
		"INSERT INTO lakesFish values( 179 , 76, 4);", 
		"INSERT INTO lakesFish values( 180 , 76, 9);", 
		"INSERT INTO lakesFish values( 181 , 76, 5);", 
		"INSERT INTO lakesFish values( 182 , 76, 6);", 
		...
		"INSERT INTO lakesFish values( 188 , 79, 4);", 
		"INSERT INTO lakesFish values( 189 , 79, 9);", 
		"INSERT INTO lakesFish values( 190 , 79, 6);", 
		"INSERT INTO lakesFish values( 191 , 80, 7);", 
		"INSERT INTO lakesFish values( 192 , 81, 7);", 
		"INSERT INTO lakesFish values( 193 , 82, 1);", 
		"INSERT INTO lakesFish values( 194 , 82, 8);", 
		"INSERT INTO lakesFish values( 195 , 82, 2);", 
		"INSERT INTO lakesFish values( 196 , 82, 4);", 
		"INSERT INTO lakesFish values( 197 , 82, 9);", 
		"INSERT INTO lakesFish values( 198 , 82, 6);", 
		"INSERT INTO lakesFish values( 199 , 83, 1);", 
		"INSERT INTO lakesFish values( 200 , 83, 2);", 
		"INSERT INTO lakesFish values( 201 , 83, 4);", 
		"INSERT INTO lakesFish values( 202 , 83, 9);", 
		"INSERT INTO lakesFish values( 203 , 83, 6);", 
		"INSERT INTO lakesFish values( 204 , 84, 2);", 
		"INSERT INTO lakesFish values( 205 , 85, 2);", 
		"INSERT INTO lakesFish values( 206 , 86, 2);", 
		"INSERT INTO lakesFish values( 207 , 86, 6);", 
		"INSERT INTO lakesFish values( 208 , 87, 2);", 
		"INSERT INTO lakesFish values( 209 , 88, 1);", 
		"INSERT INTO lakesFish values( 210 , 88, 2);", 
		"INSERT INTO lakesFish values( 211 , 88, 4);", 
		"INSERT INTO lakesFish values( 212 , 88, 13);", 
		...
		"INSERT INTO lakesFish values( 218 , 92, 21);", 
		"INSERT INTO lakesFish values( 219 , 93, 2);", 
		"INSERT INTO lakesFish values( 220 , 94, 2);", 
		"INSERT INTO lakesFish values( 221 , 94, 4);", 
		"INSERT INTO lakesFish values( 222 , 94, 6);", 
		"INSERT INTO lakesFish values( 223 , 95, 2);", 
		"INSERT INTO lakesFish values( 224 , 95, 4);", 
		"INSERT INTO lakesFish values( 225 , 95, 6);", 
		"INSERT INTO lakesFish values( 226 , 96, 2);", 
		"INSERT INTO lakesFish values( 227 , 96, 4);", 
		"INSERT INTO lakesFish values( 228 , 96, 6);", 
		"INSERT INTO lakesFish values( 229 , 97, 2);", 
		"INSERT INTO lakesFish values( 230 , 98, 2);", 
		"INSERT INTO lakesFish values( 231 , 99, 9);", 
		...
		"INSERT INTO lakesFish values( 240 , 105, 18);", 
		"INSERT INTO lakesFish values( 241 , 105, 4);", 
		"INSERT INTO lakesFish values( 242 , 105, 22);", 
		"INSERT INTO lakesFish values( 243 , 105, 6);", 
		...
		"INSERT INTO lakesFish values( 248 , 108, 8);", 
		"INSERT INTO lakesFish values( 249 , 108, 2);", 
		"INSERT INTO lakesFish values( 250 , 108, 16);", 
		"INSERT INTO lakesFish values( 251 , 108, 3);", 
		"INSERT INTO lakesFish values( 252 , 109, 2);", 
		"INSERT INTO lakesFish values( 253 , 110, 7);", 
		"INSERT INTO lakesFish values( 254 , 110, 3);", 
		"INSERT INTO lakesFish values( 255 , 111, 2);", 
		"INSERT INTO lakesFish values( 256 , 111, 12);", 
		"INSERT INTO lakesFish values( 257 , 111, 18);", 
		"INSERT INTO lakesFish values( 258 , 111, 3);", 
		"INSERT INTO lakesFish values( 259 , 112, 2);", 
		"INSERT INTO lakesFish values( 260 , 113, 1);", 
		"INSERT INTO lakesFish values( 261 , 113, 8);", 
		"INSERT INTO lakesFish values( 262 , 113, 2);", 
		"INSERT INTO lakesFish values( 263 , 113, 4);", 
		"INSERT INTO lakesFish values( 264 , 113, 14);", 
		"INSERT INTO lakesFish values( 265 , 113, 23);", 
		"INSERT INTO lakesFish values( 266 , 113, 9);", 
		"INSERT INTO lakesFish values( 267 , 113, 24);", 
		"INSERT INTO lakesFish values( 268 , 113, 5);", 
		"INSERT INTO lakesFish values( 269 , 113, 6);", 
		"INSERT INTO lakesFish values( 270 , 114, 1);", 
		"INSERT INTO lakesFish values( 271 , 114, 12);", 
		"INSERT INTO lakesFish values( 272 , 114, 2);", 
		"INSERT INTO lakesFish values( 273 , 114, 4);", 
		"INSERT INTO lakesFish values( 274 , 114, 14);", 
		"INSERT INTO lakesFish values( 275 , 114, 15);", 
		"INSERT INTO lakesFish values( 276 , 114, 9);", 
		"INSERT INTO lakesFish values( 277 , 114, 5);", 
		"INSERT INTO lakesFish values( 278 , 114, 6);", 
		"INSERT INTO lakesFish values( 279 , 115, 7);", 
		"INSERT INTO lakesFish values( 280 , 116, 2);", 
		"INSERT INTO lakesFish values( 281 , 116, 21);", 
		};
    ...
    public Cursor getAllFishPics() {
    	String select = "SELECT fish.fish_resID from fish";
    	Cursor cursor = Db.rawQuery(select,new String [] {});
    	return cursor;

    }
    
    public Cursor getAllLakesPics() {
    	String select = "SELECT lakes.depthImage_resID from lakes";
    	Cursor cursor = Db.rawQuery(select,new String [] {});
    	return cursor;
    }
    
    public Cursor getFishPicsandIDandName(int resid) {
    	String select = "SELECT fish.fish_resID, fish._id, fish.name from fish where fish.fish_resID="+resid;
    	Cursor cursor = Db.rawQuery(select,new String [] {});
    	return cursor;
    }
    
    public Cursor getFishPicsandIDandName() {
    	String select = "SELECT fish.fish_resID, fish._id, fish.name from fish";
    	Cursor cursor = Db.rawQuery(select,new String [] {});
    	return cursor;
    }
    
    public Cursor getLakePicsandID() {
    	String select = "SELECT lakes.depthImage_resID, lakes._id from lakes";
    	Cursor cursor = Db.rawQuery(select,new String [] {});
    	return cursor;
    }
    
    public Cursor getLakesFishPics(int lakeID) {
    	String select = "SELECT fish.fish_resID from fish, lakesFish where lakesFish.lakeid = " + lakeID + " and fish._id = lakesFish.fishid";
    	Cursor cursor = Db.rawQuery(select,new String [] {});
    	return cursor;
    }
    
    public Cursor getFishsLakePics(int fishID) {
    	String select = "SELECT lakes.depthImage_resID from lakes, lakesFish where lakesFish.fishid = " + fishID + " and lakes._id = lakesFish.lakeid";
    	Cursor cursor = Db.rawQuery(select,new String [] {});
    	return cursor;
    }
    
    public Cursor getLakePosition(int lakeID) {
    	String select = "SELECT lakes.latitude, lakes.longitude from lakes where lakes._id = " + lakeID;
    	Cursor cursor = Db.rawQuery(select,new String [] {});
    	return cursor;
    }
    
    public Cursor getLakeInfo(int lakeID) {
//    	latitude, longitude, maxDepth, meanDepth, area, elevation, boatInfo, fishingInfo, iceFishingInfo     	
    	String select = "SELECT latitude, longitude, maxDepth, meanDepth, area, elevation, boatInfo, fishingInfo, iceFishingInfo, depthImage_resID  from lakes where lakes._id = " + lakeID;
    	Cursor cursor = Db.rawQuery(select,new String [] {});
    	return cursor;
    }
    
    public Cursor getFishInfo(int fishID) {
    	String select = "SELECT * from fish where fish._id = " + fishID;
    	Cursor cursor = Db.rawQuery(select,new String [] {});
    	return cursor;
    }
    
    public Cursor getLakeTitle(int lakeID) {
    	String select = "SELECT lakes.name from lakes where lakes._id = " + lakeID;
    	Cursor cursor = Db.rawQuery(select,new String [] {});
    	return cursor;
    }
    
    public Cursor getFishTitle(int fishID) {
    	String select = "SELECT fish.name from fish where fish._id = " + fishID;
    	Cursor cursor = Db.rawQuery(select,new String [] {});
    	return cursor;
    }
    
    public GeoPoint getGeoPoint(int lakeID) {
    	String selectlat = "SELECT lakes.latitude from lakes where lakes._id = " + lakeID;
    	Cursor cursorlat = Db.rawQuery(selectlat,new String [] {});
    	double x = cursorlat.getFloat(0);
    	
    	String selectlon = "SELECT lakes.longitude from lakes where lakes._id = " + lakeID;
    	Cursor cursorlon = Db.rawQuery(selectlon,new String [] {});
    	double y = cursorlon.getFloat(0);
    	
    	x = x * 1000000;
    	y = y * 1000000;
    	
    	GeoPoint geo = new GeoPoint((int)x,(int)y);
    	return geo;
    	//double x = location.getLatitude() * 1000000;
		//double y = location.getLongitude() * 1000000;
    }
}
