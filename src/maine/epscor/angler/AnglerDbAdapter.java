...
public class AnglerDbAdapter {
	...
	public static final String [] INSERT_DATA_lakes = new String [] {
		"INSERT INTO LAKES values (1,'Aziscohos Lake',0,0," + R.drawable.aziscohos_lake + ",44.957528,-70.982218,60,31,6700,1518,'Boat Launch - Trailerable','No live fish as bait','Ice Fishing Closed');", 
		"INSERT INTO LAKES values (2,'Aziscohos Pond',0,0," + R.drawable.aziscohos_pond + ",44.896713,-70.990383,32,11,12,2056,'Boat Launch - Hand Carry','No live fish as bait','Ice Fishing Closed');", 
		"INSERT INTO LAKES values (3,'B Pond',0,0," + R.drawable.b_pond + ",44.743176,-70.959371,110,29,471,1389,'No Boat Launch','Artificial lures only','Ice Fishing Closed');", 
		"INSERT INTO LAKES values (4,'Barnard Pond',0,0," + R.drawable.barnard_pond + ",45.216643,-70.548539,27,6,22,1407,'No Boat Launch','No live fish as bait','Ice Fishing Closed');", 
		"INSERT INTO LAKES values (5,'Beal Pond',0,0," + R.drawable.beal_pond + ",44.903914,-70.410228,17,6,32,1337,'Boat Launch - Hand Carry','Fly Fishing Only','Ice Fishing Closed');", 
		"INSERT INTO LAKES values (6,'Beaver Mountain Lake',0,0," + R.drawable.beaver_mountain_lake + ",44.900305,-70.612432,52,22,543,1729,'Boat Launch - Trailerable','No live fish as bait','Ice Fishing Closed');", 
		"INSERT INTO LAKES values (7,'Beaver Pond (Magalloway)',0,0," + R.drawable.beaver_pond_magalloway + ",44.897112,-70.939117,72,20,179,1489,'Boat Launch - Hand Carry','Fly Fishing Only','Ice Fishing Closed');", 
		"INSERT INTO LAKES values (8,'Beaver Pond (Seven Ponds)',0,0," + R.drawable.beaver_pond_seven_ponds + ",45.260890,-70.776259,20,8,20,1991,'No Boat Launch','Fly Fishing Only','Ice Fishing Closed');", 
		...
		"INSERT INTO LAKES values (17,'Chain of Ponds',0,0," + R.drawable.chain_of_ponds + ",45.323198,-70.640110,106,24,700,1280,'No Boat Launch','General','Ice Fishing\nFrom Jan 1 to Mar 31');", 
		...
		"INSERT INTO LAKES values (30,'Ellis (Roxbury) Pond',0,0," + R.drawable.ellis_roxbury_pond + ",44.660929,-70.675771,43,10,920,830,'Boat Launch - Trailerable','General','Ice Fishing\nFrom Dec 1 to Apr 30');", 
		"INSERT INTO LAKES values (31,'Flagstaff lake',0,0," + R.drawable.flagstaff_lake + ",45.156238,-70.439798,50,18,20300,1147,'Boat Launch - Trailerable','General','Ice Fishing\nFrom Dec 1 to Apr 30');", 
		...
		"INSERT INTO LAKES values (36,'Greenbush Pond',0,0," + R.drawable.greenbush_pond + ",45.249013,-70.520662,22,'unk',21,1188,'No Boat Launch','General','Ice Fishing\nFrom Dec 1 to Apr 30');", 
		...
		"INSERT INTO LAKES values (39,'Haley Pond',0,0," + R.drawable.haley_pond + ",44.971680,-70.628887,23,8,170,1524,'Boat Launch - Hand Carry','No live fish as bait','Ice Fishing\nFrom Jan 1 to Mar 31 No live fish as bait');", 
		...
		"INSERT INTO LAKES values (61,'Lufkin Pond',0,0," + R.drawable.lufkin_pond + ",44.841090,-70.463330,28,12,47,915,'No Boat Launch','General','Ice Fishing\nFrom Jan 1 to Mar 31');", 
		...
		"INSERT INTO LAKES values (99,'Shallow Pond',0,0," + R.drawable.shallow_pond + ",45.261064,-70.533798,6,3,65,1197,'No Boat Launch','General','Ice Fishing\nFrom Dec 1 to Apr 30');", 
		...
		"INSERT INTO LAKES values (105,'Sturtevant Pond',0,0," + R.drawable.sturtevant_pond + ",44.868109,-71.021640,58,23,518,1247,'No Boat Launch','No live fish as bait','Ice Fishing\nFrom Jan 1 to Mar 31 No live fish as bait');", 
		...
		"INSERT INTO LAKES values (110,'Toothaker Pond',0,0," + R.drawable.toothaker_pond + ",44.868729,-70.397221,20,11,30,795,'No Boat Launch','No live fish as bait','Ice Fishing\nFrom Jan 1 to Mar 31 No live fish as bait 2 Lines per person');", 
		...
		"INSERT INTO LAKES values (113,'Umbagog Lake',0,0," + R.drawable.umbagog_lake + ",44.805285,-71.027154,48,14,7850,1246,'No Boat Launch','General','Ice Fishing\nFrom Jan 1 to Mar 31 No LL Salmon');", 
		"INSERT INTO LAKES values (114,'Webb Lake',0,0," + R.drawable.webb_lake + ",44.701967,-70.452740,42,24,2146,677,'Boat Launch - Trailerable','General','Ice Fishing\nFrom Jan 1 to Mar 31');", 
		...
		"INSERT INTO LAKES values (116,'Wethern (Welhern) Pond',0,0," + R.drawable.wethern_welhern_pond + ",45.213101,-70.493597,16,7,9,1187,'No Boat Launch','General','Ice Fishing\nFrom Dec 1 to Apr 30');"
		};
	...
	public Cursor getFishFromLake(int id) {
		String select = "SELECT _id,name FROM fish where _id in (SELECT fishid from lakesFish where lakeid = " + id + ")";
		Cursor cursor = database.rawQuery(select, new String[] {});
		return cursor;
	}
