...
public class AnglerDbAdapter {
	...
	public static final String [] INSERT_DATA_fish = new String [] {
		...
		"INSERT INTO fish VALUES (6 , " + R.drawable.brook_trout + ", 'Brook Trout', 'Squaretail, Brookie, Speckled Trout', 'Salvelinus fontinalis', 'Native', 'Size varies greatly, depending on water temperature, productivity, and food sources. The statewide average length of 3 year-old brook trout in Maine lakes is 13.3 inches. However, same age trout from different lakes range from 7.5 to 17.5 inches in length. Stream populations are typically slower growing than lake populations. Some high elevation trout populations mature and reproduce at lengths smaller than 6 inches.', 'Color is variable, depending on habitat. Brook trout can be distinguished from other members of the trout family by the dark, wavy, worm-like line on their back and the white leading edges of their fins, including the tail.');",
	...
	public static final String [] INSERT_DATA_lakesFish = new String [] {
			...
			"INSERT INTO lakesFish values( 265 , 113, 16);", 
